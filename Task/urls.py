...
from .views import TaskCreateAPIView, EditTaskAPIView, DeleteTaskAPIView, TaskListAPIView, UserTasksAPIView, TaskNamesListAPIView
...
urlpatterns =[
    ...
    path('display-name-list/', TaskNamesListAPIView.as_view(), name='tasks-list')
]